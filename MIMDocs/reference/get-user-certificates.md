---
title: "ユーザー証明書の取得 | Microsoft Docs"
description: 
keywords: 
author: msmbaldwin
ms.author: mbaldwin
...
---
# <a name="get-user-certificates"></a>ユーザー証明書の取得
...
成功すると、JSON でシリアル化された [Microsoft.Clm.Shared.Certificates.X509ClmCertificate](https://msdn.microsoft.com/library/microsoft.clm.shared.certificates.x509clmcertificate(v=vs.100).aspx) オブジェクトと次のプロパティの一覧が返されます。
