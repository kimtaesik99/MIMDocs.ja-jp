# [理解と調査](/microsoft-identity-manager/microsoft-identity-manager-2016)
## [MIM 2016 とは](/microsoft-identity-manager/microsoft-identity-manager-2016)
...
## [MIM 証明書管理のインストール](/microsoft-identity-manager/mim-cm-deploy)
## [BHOLD インストール関連トピック](/microsoft-identity-manager/bhold-installation-guide)
### [BHOLD コア インストール](/microsoft-identity-manager/bhold-core-installation)
### [BHOLD 統合インストール](/microsoft-identity-manager/bhold-integration-installation)
### [BHOLD 構成証明インストール](/microsoft-identity-manager/bhold-attestation-installation)
### [BHOLD モデル ジェネレーター インストール](/microsoft-identity-manager/bhold-model-generator-installation)
### [BHOLD レポート インストール](/microsoft-identity-manager/bhold-reporting-installation)
### [BHOLD 分析インストール](/microsoft-identity-manager/bhold-analytics-installation)
### [BHOLD アクセス管理コネクタ インストール](/microsoft-identity-manager/bhold-access-management-connector-install)
