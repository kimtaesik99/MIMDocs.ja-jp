...
## 基本要素
### 同期サービス
#### [MIIS 2003 テクニカル リファレンス](https://technet.microsoft.com/library/cc720628)
#### [MIIS 2003 の実行プロファイル](https://technet.microsoft.com/library/cc720554)
#### [MIIS 2003 の状態ベースの処理](https://technet.microsoft.com/library/cc720564)
#### [MIIS 2003 の同期規則](https://technet.microsoft.com/library/cc720559)
### MIM サービス
#### [フィルター ベースの送信同期の概要](https://technet.microsoft.com/library/jj133869)
#### [受信同期の概要](https://technet.microsoft.com/library/jj133856)
...
### [フォレスト間の管理の展開ガイド](https://technet.microsoft.com/library/ff721965)
### [FIM 2010 のトラブルシューティング](https://technet.microsoft.com/library/gg607341)
### [AD DS にグループをプロビジョニングする方法](https://technet.microsoft.com/library/ff686261)
### [AD DS にユーザーをプロビジョニングする方法](https://technet.microsoft.com/library/ff686263)
### [AD DS から FIM へのグループの同期方法](https://technet.microsoft.com/library/ff686936)
### [AD DS から FIM へのユーザーの同期方法](https://technet.microsoft.com/library/ff686264)
...
### [Forefront Identity Manager (FIM) 2010 を使用したグローバル アドレス一覧 (GAL) 同期の構成](https://technet.microsoft.com/video/configuring-global-address-list-gal-synchronization-with-forefront-identity-manager-fim-2010.aspx)
### [外部システムとのデータ同期について](https://technet.microsoft.com/library/ff608273)
### [プロビジョニング解除について](https://technet.microsoft.com/library/hh859718)
...
### コネクタ
### セルフ サービスのパスワード リセット
## [よく寄せられる質問](https://support.microsoft.com/lifecycle/search?alpha=Microsoft%20Forefront%20Identity%20Manager%202010,Microsoft%20Identity%20Manager%202016)
## [Microsoft ID ソフトウェア: パブリック リリース ビルド バージョン](https://blogs.technet.microsoft.com/iamsupport/idmbuildversions/)
# 開発者用リファレンス
## 同期サービス
### [同期サービス開発者向けリファレンス](https://msdn.microsoft.com/library/jj131732)
### [Extensible Connectivity 2.2 管理エージェント リファレンス](https://msdn.microsoft.com/library/hh859557)
### [同期サービスの管理対象のリファレンス](https://msdn.microsoft.com/library/jj154546)
### [ILM 2007 FP1 拡張機能のテストおよびデバッグ](https://msdn.microsoft.com/library/ms698774)
...
### [FIM 2010 の管理エージェント](https://technet.microsoft.com/library/ff608275)
### [リソース コントロールの表示構成 XML のリファレンス](https://technet.microsoft.com/library/ee534918)
### [FIM 2010 のレジストリ キーと構成ファイルの設定](https://technet.microsoft.com/library/ff800821)
### [用語と用語集](https://technet.microsoft.com/library/ee534910)
### [FIM 2010 用ツール向け Windows PowerShell](https://technet.microsoft.com/library/ff394140)
### [FIM 2010 のカスタム アクション](https://technet.microsoft.com/library/jj159300)
## [MSDN 開発者用リファレンス](https://msdn.microsoft.com/library/windows/desktop/ee652263)
